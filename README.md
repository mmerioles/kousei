...
It continuously captures device state, detects changes via syslog-triggered snapshots, and shows exactly what changed, when, and by whom—all in an offline-first, self-hosted appliance.
